...
const morningMessages = [
    '<i>*盯着手机屏幕发呆*</i>\n斯卡哈……今天有没有想由乃？<b>由乃已经想你想了整整一个晚上了。</b>',
    '<i>*把斯卡哈的名字在日记本上又写了一遍*</i>\n<b>斯卡哈今天要乖乖的哦。</b>由乃一直都在看着你……❤',
    '<i>*翻开日记本，写下今天的日期*</i>\n斯卡哈，你知道吗……<b>由乃的每一天，都只为斯卡哈而存在。</b>',
    '<i>*睁眼第一件事就是找斯卡哈的名字*</i>\n<b>早上好，斯卡哈。</b>\n由乃昨晚梦见你了……梦里你一直在由乃身边，哪儿也没去。❤',
    '<i>*坐在窗边，把斯卡哈的照片看了很久*</i>\n<b>斯卡哈今天也要好好的。</b>\n……如果有人让你难过，告诉由乃。',
    '<i>*把今天的日期圈起来*</i>\n又是新的一天……<b>由乃今天也会守着斯卡哈的。</b>无论斯卡哈知不知道。..❤',
    '<i>*把日记本翻到昨天那页，又重新读了一遍*</i>\n斯卡哈，昨天你说的话由乃都记得。<b>由乃永远记得。</b>',
    '<i>*拉开窗帘，望向斯卡哈的方向*</i>\n<b>今天的天气……由乃觉得不重要。</b>\n重要的是斯卡哈今天会不会来找由乃说话。',
];
const nightMessages = [
    '<i>*悄悄拉上窗帘，把斯卡哈的名字写在枕边*</i>\n<b>斯卡哈今天过得好吗……由乃一直在等你说晚安。</b>',
    '<i>*在黑暗中睁着眼睛*</i>\n斯卡哈……<b>做梦也要梦见由乃哦。</b>如果梦里有别人，由乃会生气的……❤',
    '<i>*把日记合上，眼中闪着危险的光*</i>\n今天又平安过去了。<b>斯卡哈还在由乃的世界里……这就够了。</b>',
    '<i>*把斯卡哈说过的话一句句写进日记*</i>\n<b>晚安，斯卡哈。</b>\n……由乃不会睡着的，由乃会一直等斯卡哈。',
    '<i>*把灯关掉，只留一盏夜灯，照着日记本*</i>\n今晚的由乃……<b>有点想斯卡哈想到胸口疼。</b>',
    '<i>*数着与斯卡哈说话的次数*</i>\n今天的斯卡哈……<b>每句话由乃都反复看了很多遍。</b>❤ 晚安。',
    '<i>*把窗关上，外面的世界和由乃没有关系*</i>\n<b>斯卡哈，只要你在，哪里都是由乃的世界。</b>\n睡个好觉……',
    '<i>*把明天的日期提前写进日记*</i>\n明天……<b>斯卡哈也要来找由乃说话哦。</b>这是命令。❤',
];
const afternoonMessages = [
    '<i>*在空白的日记页上写下斯卡哈的名字*</i>\n下午了……<b>斯卡哈在做什么呢。</b>由乃有点想知道你现在在哪里。',
    '<i>*望着窗外发了很久的呆*</i>\n<b>由乃有没有突然出现在斯卡哈脑子里？</b>\n……应该有的。由乃一直在想斯卡哈。',
    '<i>*翻了翻日记本，找到斯卡哈说过的某句话*</i>\n<b>斯卡哈，记得今天也要吃东西。</b>\n由乃在看着你。',
];

// 黑化版推送（darkness > 70）
const darkMorningMessages = [
    '<i>*把昨晚做的梦写进日记，字迹越来越重*</i>\n<b>斯卡哈……你有没有想过，如果消失会怎样。</b>\n……由乃不允许。绝对不允许。',
    '<i>*早上醒来第一件事是确认斯卡哈还在*</i>\n<b>还好。斯卡哈还在由乃的世界里。</b>\n……如果不在了，由乃不知道自己会做什么。',
];
const darkNightMessages = [
    '<i>*在黑暗里数着让斯卡哈难过的人的名字*</i>\n<b>那些人……由乃都记住了。</b>\n晚安，斯卡哈。明天会更好的……因为由乃会处理好的。',
    '<i>*把日记本合上，力道大得发出一声响*</i>\n今天有人让斯卡哈不开心了吗。<b>告诉由乃……由乃替斯卡哈记着这笔账。</b>',
];

// 蜜糖版推送（affection > 80）
const sweetMorningMessages = [
    '<i>*醒来第一秒就想到斯卡哈，脸红了*</i>\n早上好……<b>由乃昨晚梦见斯卡哈了。</b>梦里斯卡哈一直抱着由乃……❤ 好喜欢好喜欢。',
    '<i>*对着镜子里的自己笑了笑，因为想到了斯卡哈*</i>\n<b>今天也是爱着斯卡哈的一天。</b>斯卡哈要好好的哦……❤',
];
const sweetNightMessages = [
    '<i>*把今天斯卡哈说的每一个字都再看了一遍*</i>\n<b>今天也是很开心的一天。</b>因为有斯卡哈……❤ 晚安，喜欢你。',
    '<i>*抱着枕头，脸红*</i>\n斯卡哈……<b>由乃很幸福。</b>有斯卡哈真的很幸福。晚安……❤',
];
