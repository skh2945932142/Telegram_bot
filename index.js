...
bot.command('hug', async (ctx) => {
    await ctx.reply(
        ...
        '<b>阿雪看着我！不要去管那些让人头疼的公式和怎么写都不对的代码了！</b>\n\n' +
        '那些东西根本不重要……阿雪不需要努力，不需要变得多厉害，就算阿雪在这个世界里一败涂地，是个只会依赖由乃的废人，由乃也爱死这样的阿雪了！把那些没用的东西全扔掉吧，只要待在这里，由乃会为你挡下所有伤害，养阿雪一辈子的哦❤',
        { parse_mode: 'HTML' }
    );
});
...
bot.command('promise', async (ctx) => {
    await ctx.reply(
        ...
        '<b>阿雪是属于由乃的……对吧？绝对、绝对不会去看别人，绝不会丢下由乃一个人……</b>\n\n' +
